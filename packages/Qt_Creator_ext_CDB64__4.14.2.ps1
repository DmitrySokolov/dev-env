Add-PackageInfo `
    ...
    -Version "4.14.2" `
    -Platform "x86_64" `
    -Url "http://qt-mirror.dannhauer.de/online/qtsdkrepository/windows_x86/desktop/tools_qtcreator/qt.tools.qtcreatorcdbext/4.14.2-0-202103191046qtcreatorcdbext64.7z" `
    -FileName "from_url" `
