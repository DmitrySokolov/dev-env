Add-PackageInfo `
    ...
    -InstallCmd {
        & $Pkg.Installer /passive InstallAllUsers=1 TargetDir="$install_dir\Python3.7" PrependPath=1 CompileAll=1 Include_doc=0 Include_dev=0 Include_tcltk=0 Include_test=0 Include_launcher=1 InstallLauncherAllUsers=1
    } `
    -UninstallCmd {
