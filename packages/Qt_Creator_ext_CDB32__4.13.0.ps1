Add-PackageInfo `
    ...
    -Version "4.13.0" `
    -Platform "x86_64" `
    -Url "https://mirrors.dotsrc.org/qtproject/online/qtsdkrepository/windows_x86/desktop/tools_qtcreator/qt.tools.qtcreatorcdbext/4.13.0-0qtcreatorcdbext32.7z" `
    -FileName "from_url" `
