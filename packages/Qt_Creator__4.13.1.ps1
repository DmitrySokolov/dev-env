Add-PackageInfo `
    ...
    -Version "4.13.1" `
    -Platform "x86_64" `
    -Url "http://qt-mirror.dannhauer.de/online/qtsdkrepository/windows_x86/desktop/tools_qtcreator/qt.tools.qtcreator/4.13.1-0qtcreator.7z" `
    -FileName "from_url" `
    ...
    -FindCmd {
        ...
        if ('4.13.1' -ne [System.Diagnostics.FileVersionInfo]::GetVersionInfo($app).FileVersion) {
            throw 'Not found'
        }
    } `
    -InstallCmd {
