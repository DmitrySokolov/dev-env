Add-PackageInfo `
    ...
    -Version "4.12.4" `
    -Platform "x86_64" `
    -Url "https://mirrors.dotsrc.org/qtproject/online/qtsdkrepository/windows_x86/desktop/tools_qtcreator/qt.tools.qtcreatorcdbext/4.12.4-0qtcreatorcdbext64.7z" `
    -FileName "from_url" `
